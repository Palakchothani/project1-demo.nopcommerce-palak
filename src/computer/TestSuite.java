...
public class TestSuite extends Utility
{
 ...
 public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
     ...
     sendTextToElement(By.id("BillingNewAddress_FirstName"), "Peter");
     Thread.sleep(500);
     sendTextToElement(By.id("BillingNewAddress_LastName"), "White");
     Thread.sleep(500);
     sendTextToElement(By.id("BillingNewAddress_Email"), "peter123@gmail.com");
     Thread.sleep(500);
     ...
     Thread.sleep(500);
     sendTextToElement(By.id("BillingNewAddress_Address1"), "50 Green Street");
     Thread.sleep(500);
     sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "GA0 3OE");
     Thread.sleep(500);
     sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07031 201304");
     Thread.sleep(500);
     ...
     sendTextToElement(By.id("CardholderName"), "Mr P N White");
