...
public class ElectronicsTest extends Utility {
   ...
   public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
       ...
       sendTextToElement(By.id("LastName"), "White");

       selectByVisibleTextFromDropDown(By.xpath("//select[@name='DateOfBirthDay']"), "5");
       ...
       sendTextToElement(By.id("Email"), "xyz123@gmail.com");
       ...
       sendTextToElement(By.id("BillingNewAddress_FirstName"), "Palak");
       sendTextToElement(By.id("BillingNewAddress_LastName"), "Chothani");
       ...
       sendTextToElement(By.id("BillingNewAddress_Address1"), "10 Green street");
       sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "GE1 0XE");
       sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07156483215");
